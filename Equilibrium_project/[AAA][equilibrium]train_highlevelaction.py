...
# layout_v1：物品各自在两边
reward_callback_0 = EpisodeRewardCallback('final_trained_models/[equilibrium]agent0_highlevelaction_layout_v1')
reward_callback_1 = EpisodeRewardCallback('final_trained_models/[equilibrium]agent1_highlevelaction_layout_v1')
