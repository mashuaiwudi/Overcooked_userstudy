...
def train_one_combo(step_penalty_agent0: int, step_penalty_agent1: int, helping0: bool, helping1: bool):
    ...
    save_dir_agent0 = os.path.join("final_trained_models", f"[equilibrium][circle]agent0_{combo_tag}")
    save_dir_agent1 = os.path.join("final_trained_models", f"[equilibrium][circle]agent1_{combo_tag}")
