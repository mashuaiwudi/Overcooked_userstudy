...
class SingleAgentWrapper(gym.Wrapper):
    ...
    def step(self, action):
        ...
        primary_actions, real_execute_macro_actions, action_dones = self.env._computeLowLevelActions(actions)
        ...
        get_lettuce_preference_reward_up, get_lettuce_preference_reward_down = check_get_lettuce_preference(self.env, real_execute_macro_actions[0], real_execute_macro_actions[1], boolean_get_lettuce_preference_up, boolean_get_lettuce_preference_down, action_dones)

        get_plate_preference_reward_up, get_plate_preference_reward_down = check_get_plate_preference(self.env, real_execute_macro_actions[0], real_execute_macro_actions[1], boolean_get_plate_preference_up, boolean_get_plate_preference_down, action_dones)

        go_to_knife_preference_reward_up, go_to_knife_preference_reward_down = check_go_to_knife_preference(self.env, real_execute_macro_actions[0], real_execute_macro_actions[1], boolean_go_to_knife_preference_up, boolean_go_to_knife_preference_down, action_dones)

        deliver_preference_reward_up, deliver_preference_reward_down = check_deliver_preference(self.env, real_execute_macro_actions[0], real_execute_macro_actions[1], boolean_deliver_preference_up, boolean_deliver_preference_down, action_dones)
        ...
        if self.agent_index == 0:
            if agent0_previous_location != agent0_current_location:
                # print('here')
                agent0_moving_reward -= 0
            return self.obs[self.agent_index], rewards[0] + rewards[1] + agent0_moving_reward + get_lettuce_preference_reward_up + get_plate_preference_reward_up + go_to_knife_preference_reward_up + deliver_preference_reward_up, dones, info
        ...
        if self.agent_index == 1:
            ...
            return self.obs[self.agent_index], rewards[0] + rewards[1] + agent1_moving_reward + get_lettuce_preference_reward_down + get_plate_preference_reward_down + go_to_knife_preference_reward_down + deliver_preference_reward_down, dones, info
...
# layout_v1：物品各自在两边
reward_callback_0 = EpisodeRewardCallback('final_trained_models/[event]agent0_preference_0000')
reward_callback_1 = EpisodeRewardCallback('final_trained_models/[event]agent1_preference_0100')
