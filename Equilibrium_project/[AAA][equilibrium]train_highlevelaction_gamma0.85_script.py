...
class SingleAgentWrapper(gym.Wrapper):
    ...
    def step(self, action):
        ...
        # 宏动作 -> 底层动作
        primary_actions, real_execute_macro_actions, _ = self.env._computeLowLevelActions(actions)
...
def train_one_combo(step_penalty_agent0: int, step_penalty_agent1: int, helping: bool):
    ...
    combo_tag = f"a0sp_{step_penalty_agent0}_a1sp_{step_penalty_agent1}_helping_{helping}_gamma0.85"
