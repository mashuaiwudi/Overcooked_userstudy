...
class BadLettuce(Food):
    def __init__(self, pos_x, pos_y):
        super().__init__(pos_x, pos_y)
        self.rawName = "badlettuce"
...
class Plate(MovableItem):
    ...
    def containedName(self):
        dishName = ""
        foodList = [Lettuce, Onion, Tomato, BadLettuce]
        ...
        if dishName == "ChoppedLettuce-ChoppedLettuce-":
            dishName = "ChoppedLettuce-"
        return dishName[:-1]



class DirtyPlate(MovableItem):
    def __init__(self, pos_x, pos_y, containing = None):
        super().__init__(pos_x, pos_y)
        self.containing = containing
        self.rawName = "dirtyplate"
