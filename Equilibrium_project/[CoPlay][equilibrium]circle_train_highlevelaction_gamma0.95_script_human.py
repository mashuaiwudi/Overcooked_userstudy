...
# POLICY_POOL_PATH = r"../co_play_partner_pool_circle"

POLICY_POOL_PATH = r"../final_policy_pool_circle_coplay"
...
def train_one_combo(step_penalty_agent1: int, 
    ...
    save_dir_agent1 = os.path.join(
        ...
        f"[coplay][flexible][circle]agent1_{combo_tag}"
    )
    ...
    # 这里只训练 agent1 (human)，agent0 (robot) 由 policy pool 提供
